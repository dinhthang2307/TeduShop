namespace TedShop.Data.Migrations
{
    ...
    public partial class InitialDB : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.ProductsTags", "TagID", "dbo.Tags");
            DropForeignKey("dbo.ProductsTags", "ProductID", "dbo.Products");
            ...
            DropIndex("dbo.ProductsTags", new[] { "TagID" });
            DropIndex("dbo.ProductsTags", new[] { "ProductID" });
